...
const SEARCH_INDEX: SearchItem[] = [
  ...
  // All 43 modules — navegación directa
  { type: 'chapter', label: 'Portada TFG', subtitle: 'Bento Grid principal — punto de entrada del análisis forense', path: '/' },
  { type: 'chapter', label: 'Resumen Ejecutivo', subtitle: 'Brief de 5 puntos clave para el tribunal', path: '/brief' },
  { type: 'chapter', label: 'Contexto Energético', subtitle: 'Estado de la red española antes del 28-A', path: '/contexto-energetico' },
  { type: 'interactive', label: '90 Segundos (Tiempo Real)', subtitle: 'Cronología animada del colapso segundo a segundo', path: '/countdown' },
  { type: 'interactive', label: 'Cascada de Colapso', subtitle: 'Visualización forense de la propagación en cascada', path: '/cascada' },
  { type: 'interactive', label: 'Mapa Propagación', subtitle: 'Propagación geográfica del apagón por la península', path: '/map' },
  { type: 'chapter', label: 'Línea de Tiempo', subtitle: 'Secuencia cronológica de 26 eventos oficiales', path: '/timeline' },
  { type: 'chapter', label: 'Radar Causalidad', subtitle: 'Análisis de responsabilidad por actor e institución', path: '/radar' },
  { type: 'chapter', label: 'Matriz Comparada', subtitle: 'Divergencias entre informes: tabla de 5 dimensiones', path: '/matrix' },
  { type: 'chapter', label: 'Comparador de Narrativas', subtitle: 'Contraste lado a lado de los 4 informes institucionales', path: '/compare' },
  { type: 'chapter', label: 'Divergencias Irreconciliables', subtitle: 'Los 5 puntos donde Gobierno, ICAI y ENTSO-E no convergen', path: '/divergencias' },
  { type: 'chapter', label: 'Balance de Reactiva', subtitle: 'Flujo de potencia reactiva antes y durante el colapso', path: '/reactiva' },
  { type: 'chapter', label: 'Trilema Energético', subtitle: 'Tensión entre seguridad, sostenibilidad y coste', path: '/trilema' },
  { type: 'chapter', label: 'Polarímetro de Posiciones', subtitle: 'Mapa de posicionamiento de actores en 2 ejes', path: '/polarimetro' },
  { type: 'chapter', label: 'Cadena Causal', subtitle: 'Diagrama forense de causa-efecto con nodos colapsables', path: '/causal' },
  { type: 'chapter', label: 'Black Start (Fase 4)', subtitle: 'Proceso de reposición autónoma tras el colapso total', path: '/black-start' },
  { type: 'chapter', label: 'Tres Fracturas', subtitle: 'Fractura operativa, regulatoria y sistémica post-28A', path: '/fracturas' },
  { type: 'chapter', label: 'Consenso / Divergencia', subtitle: 'Visualizador de puntos de acuerdo vs. desacuerdo institucional', path: '/consenso' },
  { type: 'chapter', label: 'Narrativa Mediática', subtitle: 'Análisis del encuadre informativo en prensa y redes', path: '/narrativa-mediatica' },
  { type: 'chapter', label: 'Veredicto Forense', subtitle: 'Conclusión del análisis: causa raíz y responsabilidades', path: '/veredicto' },
  { type: 'interactive', label: 'Simulador Físico', subtitle: 'Ajusta parámetros y simula estabilidad de frecuencia', path: '/simulator' },
  { type: 'chapter', label: 'Hoja de Ruta Tecnológica', subtitle: 'Roadmap de reformas: GFM, compensadores, NC RfG 2.0', path: '/roadmap' },
  { type: 'chapter', label: 'Dossier TFG', subtitle: 'Capítulos del TFG con contenido académico completo', path: '/dossier' },
  { type: 'chapter', label: 'Galería de Figuras', subtitle: 'Galería forense de imágenes y diagramas del TFG', path: '/galeria' },
  { type: 'term', label: 'Glosario Técnico', subtitle: 'Léxico completo de términos del análisis forense', path: '/lexicon' },
  { type: 'chapter', label: 'Metodología', subtitle: 'Transparencia metodológica y triangulación de fuentes', path: '/metodologia' },
  { type: 'reform', label: 'Historial de Reformas', subtitle: 'Reformas implementadas, en tramitación y propuestas', path: '/reforms' },
  { type: 'chapter', label: 'FAQ Tribunal', subtitle: '15 preguntas y respuestas para el tribunal evaluador', path: '/tribunal' },
  { type: 'interactive', label: 'Cronología Forense', subtitle: '26 eventos oficiales con fuentes — línea de tiempo detallada', path: '/forensic-timeline' },
  { type: 'interactive', label: 'Mix de Generación', subtitle: '82% IBR el 28-A — desglose por tecnología y potencia', path: '/mix-generacion' },
  { type: 'chapter', label: 'Medidas Propuestas', subtitle: '16 medidas del Gobierno para prevenir futuros colapsos', path: '/medidas-propuestas' },
  { type: 'interactive', label: 'Interconexión ES-FR', subtitle: 'Flujo HVDC INELFE en PMODE durante el colapso', path: '/interconexion' },
  { type: 'chapter', label: 'Tres Narrativas', subtitle: 'Gobierno vs ICAI vs ENTSO-E: análisis comparativo forense', path: '/tres-narrativas' },
  { type: 'chapter', label: 'Inercia del Sistema', subtitle: 'Evolución de H y cálculo de RoCoF — vulnerabilidad 28-A', path: '/inercia-vuln' },
  { type: 'chapter', label: 'IBR Grid-Following', subtitle: 'Por qué los inversores GFL pierden estabilidad en red débil', path: '/grid-following' },
  { type: 'chapter', label: 'Fenómeno Tap-Lag', subtitle: 'Tesis ICAI: OLTC mecánico como factor agravante', path: '/tap-lag' },
  { type: 'chapter', label: 'Testimonios del 28-A', subtitle: 'Testimonios de afectados y operadores durante el apagón', path: '/testimonios' },
];
